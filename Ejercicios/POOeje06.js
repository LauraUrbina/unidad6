...
class Vehiculo{
    ...
    obtenerDetalles(){
        console.log("Numero de serie: ", this._NumeroSerie, "Marca: ", this._Marca,
        "Modelo:", this._Modelo)
    }
}
...
class Coche extends Vehiculo{
    constructor(numeroserie, marca, modelo, numeropuertas){
        ...
        this._NumPuertas = numeropuertas
    }
    obtenerDetalles(){
        console.log("Numero de serie: ", this._NumeroSerie, "Marca: ", this._Marca,
        "Modelo:", this._Modelo, "Numero de puertas: ", this._NumPuertas)
    }
    arrancar(){
...
class Moto extends Vehiculo{
    ...
    obtenerDetalles(){
        console.log("Numero de serie: ", this._NumeroSerie, "Marca: ", this._Marca,
        "Modelo:", this._Modelo, "Cilindraje: ", this._Cilindraje)
    }
    Acelerar(){
...
class Bicicleta extends Vehiculo{
    ...
    obtenerDetalles(){
        console.log("Numero de serie: ", this._NumeroSerie, "Marca: ", this._Marca,
        "Modelo:", this._Modelo, "Tipo de Bicicleta: ", this._Tipo)
    }
    pedalear(){
        console.log("la bicicleta de tipo: ", this._Tipo, "esta en uso actualmente")
    }
}
...
class Camion extends Vehiculo{
    ...
    obtenerDetalles(){
        console.log("Numero de serie: ", this._NumeroSerie, "Marca: ", this._Marca,
        "Modelo:", this._Modelo, "Capacidad: ", this._Capacidad,
        "Numero de ejes: ", this._NumEjes)
    }
    cargando(){
...
miCoche.arrancar()
let miMoto = new Moto("m7894", "Yamaha", 2015, 1600)
miMoto.obtenerDetalles()
miMoto.Acelerar()
let miBici = new Bicicleta(456, "Poseidon", 2018, "Carreras")
miBici.obtenerDetalles()
miBici.pedalear()
let miCamion = new Camion("cbd789", "Foton", 2016, 2, 6)
